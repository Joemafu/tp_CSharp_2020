...
namespace TP_02_2020
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("<-----------PRESIONE UNA TECLA PARA CONTINUAR----------->");
            Console.Beep();
            /// Esta pausa no está en el ejecutable provisto, pero si se descomenta permite ver el detalle 
            /// de las motos hasta que se presione una tecla.
            //Console.ReadKey();
            Console.Clear();
